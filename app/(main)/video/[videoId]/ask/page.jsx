    ...
    try {
      ...
      if (response.status !== 200 || !response?.data?.answer) {
        setMessages((prev) => [
          ...prev,
          {
            text: "I am unable to answer this question right now or you have exceeded limits. Is there any other question?",
            isUser: false,
          },
        ]);
        return;
          ...
          <div className="mx-auto max-w-2xl">
            <div className="space-y-4 pb-[100px]">
              {messages.map((message, index) => (
                ...
                >
                  <div
                    className={`flex items-start space-x-2 rounded-lg px-4 py-2 max-w-[80%] ${message.isUser
