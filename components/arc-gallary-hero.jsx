      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-6 -mt-40 md:-mt-52 lg:-mt-64">
        ...
        >
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-foreground">
            Make Lib your new study home
          </h1>
          <p className="mt-4 text-lg text-muted-foreground">
            Master any topic 10x faster with AI-powered notes and community-driven insights.
          </p>
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href={"/home"} className="w-full sm:w-auto px-8 py-4 rounded-full bg-primary text-primary-foreground font-semibold hover:bg-primary/90 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
              Start Learning
            </Link>
            <Link target="_blank" href={"https://github.com/aakashsharma003/lib"} className="w-full sm:w-auto px-8 py-4 rounded-full border border-border font-semibold hover:bg-accent hover:text-accent-foreground transition-all duration-200">
              Github
            </Link>
          </div>
        </div>
